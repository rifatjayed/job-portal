...
function About() {
  return (
    ...
    //     <div className="mx-auto w-[1100px] max-w-full flex flex-col md:flex-row justify-between items-center gap-8 md:gap-16 px-4">
    //       <div className="flex-1">
    //         <img
    //           className="rounded w-full md:w-auto"
    //           src="/Rectangle 2746.png"
    //           alt=""
    //         />
    //       </div>
    //       <div className="flex-1 px-10">
    //         <h1 className="text-2xl md:text-[40px] font-bold pb-6 pl-8 md:pl-0 ">
    //           Mission
    //         </h1>
    ...
    //       <div className="flex-1">
    //         <img
    //           className="rounded w-full h-64 md:h-full"
    ...
    <>
      ...
      <div className="w-full bg-gray-100 py-20">
        <div className="mx-auto w-[1100px] max-w-full flex flex-col md:flex-row justify-between items-center gap-8 md:gap-16 px-4">
          ...
          <div className="flex-1 px-4 md:px-10">
            <h1 className="text-2xl md:text-[40px] font-bold pb-6">Mission</h1>
            <ul className="pl-1 px-4 md:px-0">
              <li className="w-full flex items-center gap-3 py-4 border-b border-b-gray-400">
                <span className="flex-shrink-0 w-3 h-3">
                  <BulletIcon className="w-full h-full" />
                </span>{" "}
                To connect job seekers with their ideal jobs
              </li>
              <li className="w-full flex items-center gap-3 py-4 border-b border-b-gray-400">
                <span className="flex-shrink-0 w-3 h-3">
                  <BulletIcon className="w-full h-full" />
                </span>{" "}
                To provide employers with top talent
              </li>
              <li className="w-full flex items-center gap-3 py-4 border-b border-b-gray-400">
                <span className="flex-shrink-0 w-3 h-3">
                  <BulletIcon className="w-full h-full" />
      ...
      <div className="w-full py-20">
        <div className="mx-auto w-[1100px] max-w-full flex flex-col-reverse md:flex-row justify-between items-stretch gap-8 md:gap-16 px-4">
          <div className="flex-1 my-auto px-4 md:px-0">
            <h1 className="text-2xl md:text-[40px] font-bold pb-6">Mission</h1>
            <ul className="pl-1 px-4 md:px-0">
              <li className="w-full flex items-center gap-3 py-4 border-b border-b-gray-400">
                <span className="flex-shrink-0 w-3 h-3">
