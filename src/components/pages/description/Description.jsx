                ...
                <div className='flex justify-between gap-[45px]  '>
                    ...
                    <div>
                        ...
                        <div className='flex gap-[18px] font-normal text-base'>
                            ...
                            <p className=' text-[#FF0000] bg-[#FFEDED] rounded-3xl px-[10px] py-[6px]'>Multinational brand</p>
                        </div>
                        ...
                        <div>
                            ...
                            <div className='mt-[15px]'>
                                <h1 className='text-xl text-black font-semibold'>Responsibilities</h1>
                                <ul className="list-disc list-inside text-base text-gray-800 ">
                                    <li>Bachelor’s degree in Computer Science, Information Technology, or a related field.</li>
                                    <li>Proven experience as a Software Administrator or similar role.</li>
                                    <li>Proficiency in software installation, configuration, and troubleshooting.</li>
                    ...
                    <div className=''>
                        <div className='flex mb-[40px]'>
                            <div> <button className='text-base text-white bg-[#0A65CC] px-[48px] py-[12px] '>
                                Apply now
                            </button></div>
                            ...
                            <div className='p-[24px] border border-red-500'>
                                <h4 className='mb-[24px]'>Skills</h4>
                                  <div className='flex flex-wrap gap-3 mt-[20px] mb-[40px]'>
                                                            <p className='flex text-base bg-[#F1F2F4] p-1 justify-center items-center '>Web Development
                                                                <span className='bg-white ml-[8px]'>
                                                                    <RxCross2 />
                                                                </span>
                                
                                                            </p>
                                                            <p className='flex text-base bg-[#F1F2F4] p-1 justify-center items-center '>User Interface Design
                                                                <span className='bg-white ml-[8px]'><RxCross2 /> </span>
                                                            </p>
                                                            <p className='flex text-base bg-[#F1F2F4] p-1 justify-center items-center '>HTML
                                                                <span className='bg-white ml-[8px]'><RxCross2 /> </span>
                                                            </p>
                                                            <p className='flex text-base bg-[#F1F2F4] p-1 justify-center items-center '>HP Programming 
                                                                <span className='bg-white ml-[8px]'><RxCross2 /> </span>
                                                            </p>
