  ...
  return (
    ...
    <div className="flex flex-col items-center gap-14 px-8 md:px-6">
      <div className="flex flex-col lg:flex-row gap-10 lg:gap-30 w-full">
        ...
        {/* Right Side */}
        <div className="w-full md:w-[712px] flex flex-col sm:flex-row justify-between gap-6">
          <div className="flex-1 flex items-center gap-3 p-4 border border-blue-600 rounded">
            <div className="w-12.5 h-12.5 bg-gray-100 p-[9px] rounded">
              <PaperIcon />
            </div>
      ...
      {/* Signature Section */}
      <div className="px-6 md:px-10 py-6 border border-gray-200 rounded flex flex-col md:flex-row md:justify-between md:items-center gap-6 md:gap-30">
        {/* Left Side */}
        <div className="md:w-[260px] flex flex-col gap-3">
          <h1 className="text-[20px] font-semibold">Signature</h1>
          <p className="text-[14px] text-gray-600">
